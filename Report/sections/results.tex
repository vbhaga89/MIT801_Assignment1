...
\begin{tabular}{|c|c|c|c|c|}
    \hline
    Train PR-AUC ($\mu \pm \sigma$) & Val PR-AUC ($\mu \pm \sigma$) & Test PR-AUC & Val Rec@P $\geq$ 0.8 ($\mu \pm \sigma$) & Train time (s)\\
    \hline
    0.04868 $\pm$ 0.002375 & 0.04133 $\pm$ 0.01357 & 0.06050 & 0.0 $\pm$ 0.0 &  2.808\\
    \hline
\end{tabular}
}
\label{baseline}
...
The default parameters of the SGDClassifier model were used. The only parameters that were changed were the following:
...
\begin{tabular}{|c|c|c|c|c|c|}
    \hline
    LR (eta0) & Train PR-AUC ($\mu \pm \sigma$) & Val PR-AUC ($\mu \pm \sigma$) & Test PR-AUC & Val Rec@P $\geq$ 0.8 ($\mu \pm \sigma$) & Train Time (s) \\
    \hline
    1e-4 & 0.1450 $\pm$ 0.008539 & 0.09967 $\pm$ 0.03497 & 0.1070 & 0.0006289 $\pm$ 0.001406 & 4.3201\\
    1e-3 & 0.1584 $\pm$ 0.01289 & 0.1071 $\pm$ 0.03752 & 0.1071 & 0.001258 $\pm$ 0.002813 & 3.538\\
    1e-2 & 0.1383 $\pm$ 0.02150 & 0.09606 $\pm$ 0.03860 & 0.08772 & 0.001023 $\pm$ 0.001461 & 3.360\\
    \hline
\end{tabular}
}
...
\begin{tabular}{|c|c|c|c|c|c|c|}
    ...
    \hline
    1 & 3e-3 & 1e-5 & l$_{1}$ & balanced & 0.108537 $\pm$ 0.030966 & 2.024\\
    2 & 3e-3 & 1e-6 & l$_{1}$ & balanced & 0.108509 $\pm$ 0.030986 & 2.825\\
    3 & 1e-3 & 1e-3 & l$_{1}$ & balanced & 0.108495 $\pm$ 0.032532 & 2.009\\
    4 & 3e-3 & 1e-4 & l$_{1}$ & balanced & 0.108466 $\pm$ 0.031692 & 2.056\\
    5 & 3e-3 & 1e-6 & l$_{2}$ & balanced & 0.108432 $\pm$ 0.030833 & 1.925\\
    \hline
\end{tabular}
}
\label{gridsearch}
...
\begin{tabular}{|c|c|c|c|}
    \hline
    \#Evals & Runtime (min) & Best Val PR-AUC ($\mu \pm \sigma$) & Test PR-AUC \\
    \hline
    119 & 1.717 & 0.181609 $\pm$ 0.129919 & 0.09752\\
    \hline
\end{tabular}
}
...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    Grid Search & 80 & 2.433 & 0.1085 & 0.1082\\
    Bayesian Opt & 40 & 2.967 & 0.1071 & 0.1101\\
    \hline
\end{tabular}
}
\label{bayesian_grid}
